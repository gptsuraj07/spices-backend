...
def product_helper(product) -> dict:
    return {
        ...
        "weightUnit": product.get("weightUnit", product.get("unit", "g")),
        "sku": product.get("sku", ""),
        ...
        "imagePosition": product.get("imagePosition", "center center"),
        "imageFit": product.get("imageFit", "contain"),
        "imageScale": product.get("imageScale", 1.0),
